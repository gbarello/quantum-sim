    ...
    // =====================================================================
    {
      ...
      controls: [
        // Total Probability Display
        {
          ...
          // Getter function to retrieve current value
          getValue: (manager) => {
            ...
            return manager.simulation.psi.sumAbs2();
          }
        },
        ...
        // Time Elapsed Display
        {
          ...
          // Getter function to retrieve current value
          getValue: (manager) => {
            if (!manager || !manager.simulation) return null;
        ...
        // Measurement Count Display
        {
          ...
          // Getter function to retrieve current value
          getValue: (manager) => {
            if (!manager || !manager.state) return 0;
